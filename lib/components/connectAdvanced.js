  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    function (_OuterBaseComponent) {
      ...
      function Connect(props) {
        ...
        _this.indirectRenderWrappedComponent = _this.indirectRenderWrappedComponent.bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
        return _this;
      }
